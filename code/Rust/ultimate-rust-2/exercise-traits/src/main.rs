...
impl PartialEq for Party {
    // reference: https://doc.rust-lang.org/std/cmp/trait.PartialEq.html#how-can-i-implement-partialeq
...
impl From<Party> for Cake {
    // reference: https://doc.rust-lang.org/rust-by-example/conversion/from_into.html
