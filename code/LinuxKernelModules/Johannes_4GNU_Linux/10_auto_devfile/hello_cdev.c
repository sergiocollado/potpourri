// reference: https://youtu.be/DG0CRvxI5lY
...
// we have to create our own class in /sys/class and then register a range
// of device numbers, create our character device and create a device out of
// the device number and the class we had previously created.
