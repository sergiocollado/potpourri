...
int main(void)
{
    ...
    {
       printf(" uname: %s\n", systemName.sysname);
       syslog(LOG_INFO, "[COURSE:2][ASSIGNMENT:3]: %s %s %s %s %s", systemName.sysname, systemName.nodename, systemName.release, systemName.version, systemName.machine);   
    }
...
void *Sequencer(void *threadp)
{
    ...
    do
    {
        ...
        // Service_4 = RT_MAX-3	@ 5 Hz
        if ((seqCnt % 20) == 0) { sem_post(&semS4); printf(" S4"); }
...
void *Service_1(void *threadp)
{
    ...
    while(!abortS1)
    {
        ...
        syslog(LOG_INFO, "[COURSE:2][ASSIGNMENT:3]: Thread %d start %lld @%6.9lf on core 1\n", threadParams->threadIdx, S1Cnt, current_realtime-start_realtime);
    }
...
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Linux debian 4.19.0-16-amd64 #1 SMP Debian 4.19.181-1 (2021-03-19) x86_64
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 1 @0.000080404 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 2 start 1 @0.009703503 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 3 start 1 @0.019360531 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 2 @0.020381896 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 4 start 1 @0.041752719 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 3 @0.042885889 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 2 start 2 @0.052968512 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 4 @0.064144277 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 5 @0.090676940 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 6 @0.111512661 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 2 start 3 @0.121112767 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 7 @0.132258978 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 8 @0.155525648 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 2 start 4 @0.165726314 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 3 start 2 @0.175310419 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 9 @0.175857919 on core 1
Dec 12 19:52:33 debian sequencer[3812]: [COURSE:2][ASSIGNMENT:3]: Thread 1 start 10 @0.196889724 on core 1
*/
